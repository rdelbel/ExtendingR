...
We will briefly go over some of the main functions in reportRx. I wll show most of the R code so you can see how to use the functions. In practice you should hide the R code using echo=F. 
